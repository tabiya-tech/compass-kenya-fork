...
class TestProfileGenerator:
    ...
    def test_encode_profile_linear_coding(self, config_file):
        ...
        assert features[0] == 1.0  # 10000 / 10000
        assert features[1] == 0.0  # flexibility base level
    ...
    def test_encode_profile_categorical_coding(self, config_file):
        ...
        assert len(features) == 2
        assert features[0] == 2.0  # 20000 / 10000
        assert features[1] == 1.0  # flexibility non-base level
